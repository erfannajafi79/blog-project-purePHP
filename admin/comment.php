                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($comment['status']) {
                                                ?>
                                                <a href="#" class = "btn btn-outline-success">تایید شده</a>
                                                <?php
                                            }  else {
                                                ?>
                                                <a href="comment.php?action=approve&id=<?php echo $comment['id']; ?>" class="btn btn-outline-success">در انتظار تایید</a>
                                                <?php
                                            }
                                            ?>
